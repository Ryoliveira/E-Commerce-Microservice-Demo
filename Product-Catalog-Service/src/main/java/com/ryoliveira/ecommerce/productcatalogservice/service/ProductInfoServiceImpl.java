...
public class ProductInfoServiceImpl implements ProductInfoService {
    ...
    @Override
    public void updateMainProductImage(MultipartFile mainProductImageFile, int productId) {
